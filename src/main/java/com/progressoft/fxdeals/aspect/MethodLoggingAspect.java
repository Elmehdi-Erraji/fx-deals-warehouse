package com.progressoft.fxdeals.aspect;
...
public class MethodLoggingAspect {
    ...
    @Before("execution(* com.progressoft.fxdeals.services.implementation.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.progressoft.fxdeals.services.implementation.*.*(..))", throwing = "exception")
    ...
    @AfterReturning(pointcut = "execution(* com.progressoft.fxdeals.services.implementation.*.*(..))", returning = "result")
